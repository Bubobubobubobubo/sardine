...
#+begin_quote
Sardine is a free/open-source software for Python 3.10+. It turns Python into a musical instrument. You can play it alone or with your friends by sharing code and tempo. *With Sardine you can*:
...
** TODO Writing presets

- How to write presets using dictionaries
