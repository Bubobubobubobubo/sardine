...
- Play collaboratively / synchronise your code with your friends.
- Extend *Sardine* using any *Python* package.

*Sardine* is designed for you to explore algorithmic improvisation using a friendly syntax/environment. This software is made for music, it transforms *Python* in a musical instrument capable of sequencing any event in time. The code can be updated anytime while the program is running, a technique called *live coding*!
...
Don't focus too much on it for the moment, we will come back to it later on!
...
We have learned how to play a specific sound, how to give it parameters, and how to specify a simple rhythm. However, we don't always want to play an audio sample or a synthesizer. Some other event types that might be interesting are :
- *MIDI* notes or controls
- *OSC* messages
