...
A parametric silence will cause the pattern to search its last value and hold it. **Sardine** will backtrack and search the last value that could have been generated by the pattern. The result of the `speed` parameter will then be `[1 2 3 4 4 4 4 4 4 4 4 4]`.
