...
export const tutorialText = {
  "0.0 Using the code editor": about_tutorial,
  "1.0 Time, clock(s), period": time_tutorial,
  "1.1 Playing sound samples": sound_tutorial,
  "1.2 Exploring sound samples": exploring_sound_tutorial,
  "1.3 SuperDirt audio effects": exploring_effects_tutorial,
  "1.3 Playing MIDI instruments": midi_tutorial,
  "1.4 Sardine Pattern Language": spl_tutorial,
  "1.5 Patterns": pattern_tutorial,
}
