...
def sometimes(): return True if random() < 0.5 else False
def rarely(): return True if random() < 0.25 else False
def almostNever(): return True if random() < 0.10 else False
